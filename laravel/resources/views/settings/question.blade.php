    ...
    <main class="py-5 pt-3">
        <div class="container" style="max-width: 850px;">
            ...
            <div class="d-flex gap-2 mb-4 bg-white p-2 rounded-4 shadow-sm border border-light-subtle">
                <a href="{{ route('settings.password') }}" class="nav-link-custom text-decoration-none flex-fill text-center">
                    <i class="bi bi-shield-lock-fill me-2"></i>Change Password
                </a>
                <a href="{{ route('settings.question') }}" class="nav-link-custom text-decoration-none active flex-fill text-center">
